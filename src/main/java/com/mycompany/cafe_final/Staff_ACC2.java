 ...
 */
public class Staff_ACC2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Parola d'ordine");
        ...
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 430, 192, -1));
        getContentPane().add(t2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 192, -1));
        getContentPane().add(t3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 270, 192, -1));
        getContentPane().add(t4, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 310, 192, -1));
        getContentPane().add(t1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 190, 192, -1));
        getContentPane().add(t5, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 350, 192, -1));
        getContentPane().add(t6, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 390, 192, -1));

        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Ho un account");
        ...
        getContentPane().add(t0, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 190, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(username.length()<5 || username.length() > 10){
            JOptionPane.showMessageDialog(this, "Il nome utente deve contenere da 5 a 10 caratteri.","Error",1);
            return;
        }
        if(password.length()<8){
            JOptionPane.showMessageDialog(this, "La password deve contenere almeno 8 caratteri.","Error",1);
            return;
        }
        
        if(firstname.length()<5){
            JOptionPane.showMessageDialog(this, "Il nome deve contenere almeno 5 caratteri","Error",1);
        }
        
        if(lastname.length()<8){
            JOptionPane.showMessageDialog(this,"Il cognome deve contenere almeno 8 caratteri","Error",1);
        }
        
        if(!gmail.endsWith("@gmail.com")){
            JOptionPane.showMessageDialog(this, "L'indirizzo Gmail deve terminare con @gmail.com.","Error",1);
        return;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Staff_ACC2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Staff_ACC2().setVisible(true);
            }
        });
    }
